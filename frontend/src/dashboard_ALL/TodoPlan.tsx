  ...
  const compulsoryTasks: CompulsoryTask[] = useMemo(() => {
    ...
    return [
      ...
      },
      {
        id: 'photos-add',
        title: 'Add photos',
        description: 'Create a QR code for your event to share with guests',
      ...
      },
      {
        id: 'invite-earn',
        title: 'Invite & Earn',
        description: 'Refer friends and earn rewards when they join',
        completed: false,
        tabId: 'invite',
        Icon: Share2,
      },
      {
        id: 'upgrade',
        title: 'Upgrade',
        description: 'Upgrade your event to keep 100% of your cash gift (no charges) and access to premium websites and invitations',
