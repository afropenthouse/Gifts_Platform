      ...
      <section className="py-12 px-4 md:py-16 md:px-6">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="prose prose-lg mx-auto text-center mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              Guests can send cash gifts:
            </p>
            <ul className="list-disc list-inside text-muted-foreground leading-relaxed mb-6 text-left max-w-2xl mx-auto">
              <li>Before the wedding</li>
              <li>On the wedding day</li>
              <li>After the wedding</li>
            </ul>
            <p className="text-muted-foreground leading-relaxed mb-6">
              All gifts are recorded in one place, making it easy to track and acknowledge generosity without stress.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-6">
              With Be There Weddings, you can:
            </p>
            <ul className="list-disc list-inside text-muted-foreground leading-relaxed mb-6 text-left max-w-2xl mx-auto">
              <li>Share one cash gift link with guests</li>
              <li>Receive gifts securely</li>
              <li>Track all gifts in your dashboard</li>
              <li>Avoid handling physical cash at events</li>
            </ul>
            <p className="text-muted-foreground leading-relaxed mb-8">
              It’s simple, respectful, and designed for modern weddings.
            </p>
          </div>
