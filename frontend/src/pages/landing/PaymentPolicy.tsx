      ...
      <main className="flex-grow container mx-auto px-4 py-12 md:py-20">
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="text-center p-8 bg-[#2E235C]/5 rounded-2xl">
            ...
            <p className="text-sm text-muted-foreground">
              BeThere Experience operates in compliance with Nigerian financial regulations. We are committed to ensuring a safe and transparent environment for wedding gifting.
            </p>
          </div>
        </div>
      </main>
