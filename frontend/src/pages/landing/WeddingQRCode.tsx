      ...
      <section className="py-12 px-4 md:py-16 md:px-6">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="prose prose-lg mx-auto text-center mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              Be There Weddings provides a dedicated QR code that guests can scan to send cash gifts instantly.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-6">
              Simply display your QR code at the venue — on tables, screens, or frames — and guests can send gifts in seconds using their phones.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-6">
              Benefits include:
            </p>
            <ul className="list-disc list-inside text-muted-foreground leading-relaxed mb-6 text-left max-w-2xl mx-auto">
              <li>Fast and easy gifting at the venue</li>
              <li>No need to announce bank details</li>
              <li>Reduced cash handling</li>
              <li>A clean, modern gifting experience</li>
            </ul>
            <p className="text-muted-foreground leading-relaxed mb-8">
              The QR code links directly to your cash gift page, making gifting effortless for guests.
            </p>
          </div>
